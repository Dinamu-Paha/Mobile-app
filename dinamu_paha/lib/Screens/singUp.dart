...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Future verificationCodeSubmit() async{
    // print(code);
    // print(email);
    final res = await http.post( Uri.parse('http://ec2-54-215-42-250.us-west-1.compute.amazonaws.com:8080/user/mailverify'),
  ...
  Future save() async{
    ...
    // print(formattedDob);
    final res = await http.post( Uri.parse('http://ec2-54-215-42-250.us-west-1.compute.amazonaws.com:8080/user/signup'),
        headers:{'Content-Type':'application/json'},
